...
if (message.content.startsWith(prefix + "عواصم")) {
  ...
  const item = awasem[Math.floor(Math.random() * awasem.length)];
  const filter = response => {  
      return item.answers.some(answer => answer.toLowerCase() === response.content.toLowerCase());
  };
  message.channel.send('**:loudspeaker: , لقد بدأت اللعبة الان !**').then(msg => {
...
==================================================================
link Bot : https://discordapp.com/oauth2/authorize?client_id=528493036246663178&permissions=0&scope=bot
